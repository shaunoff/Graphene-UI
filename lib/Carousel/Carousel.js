		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_grapheneUi.Icon, { size: '30px', name: 'arrowLeftCircle' })
				),
				_react2.default.createElement(
					'div',
					{ style: styles.panel },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_grapheneUi.Icon, { size: '30px', name: 'arrowRightCircle' })
				),
				_react2.default.createElement(
					'div',
					{
