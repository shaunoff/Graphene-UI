...
var _dist = require('react-simple-line-icons/dist');
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_dist2.default, { color: '#585858', size: 'large', name: 'arrow-left-circle' })
				),
				_react2.default.createElement(
					'div',
					{ style: styles.panel },
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_dist2.default, { color: '#585858', size: 'large', name: 'arrow-right-circle' })
				),
				_react2.default.createElement(
					'div',
					{
