    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { style: { display: 'flex', justifyContent: 'flex-start', alignItems: 'center', height: '40px', padding: "0px 10px" } },
        ...
        this.props.count && _react2.default.createElement(
          'div',
          { style: { color: '#6bada7', fontWeight: '600', textAlign: 'center', width: '20px', border: '2px solid #6bada7', padding: '9px 6px 10px 6px', borderRadius: '0px 4px 4px 0px' } },
          this.props.count
        )
      );
    }
