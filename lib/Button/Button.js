...
var Button = function (_React$Component) {
  ...
  _createClass(Button, [{
    ...
    value: function renderLeftIcon() {
      var children = _react2.default.Children.count(this.props.children);
      return _react2.default.createElement(
        'div',
        { style: { position: 'relative', left: children === 0 ? '0px' : "-10px", marginRight: '0px' } },
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          Object.assign({ style: { padding: '0px' }
          }, this.getButtonProps()),
          _react2.default.createElement(
            'div',
            { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', height: '35px', padding: "0px 6px" } },
