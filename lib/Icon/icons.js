...
var icons = {
	...
	arrowLeftCircle: {
		paths: ["M7.52,7.59h0a.74.74,0,0,0-1,0L4.1,10.07a1.49,1.49,0,0,0,0,2.06l2.38,2.51a.75.75,0,0,0,1,0h0a.75.75,0,0,0,0-1.06l-1-1.09a.39.39,0,0,1,.27-.65H17.94c.41,0,.62-.34.62-.75h0c0-.42-.21-.76-.62-.76H6.77a.37.37,0,0,1-.28-.62L7.55,8.64A.74.74,0,0,0,7.52,7.59Z"],
		circles: [{
			x: "11.12",
			y: "11.12",
			r: "10.12",
